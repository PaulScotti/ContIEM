function [avgest,sd] = AvgCingleBetaInROI(yy,id,roipath) 
    numTrials = 40;
%     load('/lab/Paul/ContIEM/101/Session_1/ColorEncoder/Color_Encoder_scripts.mat');
    ...
    t2 = 0;
    for t = 1:numTrials
        filedir = strcat('cTrial',num2str(t));
        cd(filedir)
        load('SPM.mat')
