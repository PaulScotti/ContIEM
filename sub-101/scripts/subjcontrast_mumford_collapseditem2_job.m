...
if ~(7 == exist('Object72','dir')) %does Object72 folder exist? if not, create the folders
...
for object = 37:numObjects
    ...
    for run = 1:numRuns
        if any(run == R)
            ...
            matlabbatch{1}.spm.stats.fmri_spec.sess(run).cond(2).name = ['Object_' num2str(object)];
